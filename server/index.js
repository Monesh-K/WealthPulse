...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "https://cdn.jsdelivr.net", "https://unpkg.com", "https://accounts.google.com", "https://apis.google.com", "https://www.gstatic.com"],
...
app.post('/api/ai/insight', requireAuth, async (req, res) => {
  try {
    ...
    const result = await aiService.getInsight(type, data || {});
    res.json(result);
  } catch (e) {
...
// 5. Monthly snapshot on 1st of each month at 9 AM IST
cron.schedule('0 9 1 * *', () => {
